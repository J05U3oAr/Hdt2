 ...
 * Arodi Chavez - 241112
 * Fecha: 30/01/2025
 * Descripción: Implementación de una calculadora que utiliza un stack para evaluar 
 * expresiones matemáticas en notación postfija. Soporta las operaciones básicas (+, -, *, /, %).
 */
